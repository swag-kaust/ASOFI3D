...
void model_elastic(float  ***  rho, float ***  pi, float ***  u,
    ...
    /*const float vpv1=2326.0, poi1=0.25, 
     ...
     rho1=2000.0, h=10000.0; */
   const float vpv1=2326.0, poi1=0.25, 
           epsx1=0.0, epsy1=-0.0, 
           delx1=-0.166, dely1=-0.166, 
           delxy1=0,
           gamx1=0.0, gamy1=0.0, rho1=2000.0, h=10000.0;
        ...
        for (k=1;k<=NZG;k++){
            for (i=1;i<=NXG;i++){
                for (j=1;j<=NYG;j++){
                    ...
                    Vsv=0.0000894; //Vpv*sqrt((1-2*Poi)/(2-2*Poi));
                    muv=Vsv*Vsv*Rho;
                    piv=Vpv*Vpv*Rho;
