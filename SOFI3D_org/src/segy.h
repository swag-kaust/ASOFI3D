...
/*the following function heads have been commented due to compilation problems (no further investigations were done)
 * the segy output is nevertheless identical to that of the previous segy.h version (copyright from 1996)
 */
