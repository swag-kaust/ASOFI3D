...
\end{eqnarray}
In gneral anisotropic medium it leads the 21 elastic constants. We focus on orthorhombic medium which has 9 constants depicted in \cref{fig:CijOrtho}. Orthorhombic \cite{kazei2018}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{defaultSnap.eps}
	\caption{}
	\label{fig:defaultSnap}
\end{figure}


merge_snapshots.m, can help you merge snapshots faster than snapmerge, if they fit into the ram memmory of your workstation.
