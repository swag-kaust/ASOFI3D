...
\title{ASOFI anisotropic viscoelastic seismic modeling with finite differences (anisotropic SOFI3D)}
...
To compile the program do: 
 ...
 \lstinline{cd src && make all}. 
 
You might need to change \lstinline{src/Makefile} to succeed. 

To run the program on 8 CPUs do

 \lstinline{cd par && mpirun -np 8 ../bin/sofi3D ./in_and_out/sofi3D.json}
